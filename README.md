...
| [Everything Together](psycheros-everything-together/README.md)         | `0.4.0-rc.2` | Release suite              | Expression + Screen source bridge with exact Accessibility, Shell, and HTF manager ZIPs.           |

Manager plugins target Psycheros `>=0.10.0 <0.12.0`. Source bridges target
exactly `0.11.2`, verify stock-file hashes before writing, back up replaced
