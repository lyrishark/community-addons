...
| --- | --- | --- | --- |
| [HTF Music Listener](psycheros-htf-music-listener/README.md) | [0.3.0-rc.1](https://github.com/lyrishark/community-addons/releases/tag/psycheros-htf-music-listener-v0.3.0-rc.1) | Settings > Plugins | Local HTF listening, sensory library, synced lyrics, and Windows/macOS/Linux Now Playing presence. |
...
| [Everything Together](psycheros-everything-together/README.md) | [0.3.0-rc.2](https://github.com/lyrishark/community-addons/releases/tag/psycheros-everything-together-v0.3.0-rc.2) | Release suite | Merged source bridge plus Accessibility, Shell, and current cross-platform HTF plugin ZIPs. |
