...
| [Accessibility Controls](psycheros-accessibility-controls/README.md) | 0.1.0-rc.1 prepared | Settings > Plugins | Persistent font presets and text scale plus adaptive, manually resizable Yin Yang voice text input. |
...
| [Entity Core for Codex](codex-entity-core-plugin/README.md) | 0.2.2 prepared; 0.2.1 public | Codex MCP/plugin package; its bundled Entity Core snapshot is separate from the Psycheros 0.10 runtime. |
