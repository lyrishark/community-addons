...
These packages are preserved through Git tags, releases, and the final 0.9.2
source snapshot. They replaced host files and are not compatible with the
Psycheros 0.10 plugin manager.

Do not copy any of these source trees over Psycheros 0.10.

| Package | Last public release | Final 0.9.2 source | Current status |
| --- | --- | --- | --- |
...
| Windows Shell Fix | [0.1.1](https://github.com/lyrishark/community-addons/releases/tag/psycheros-windows-shell-fix-v0.1.1) | [0.2.0 snapshot](https://github.com/lyrishark/community-addons/tree/b9094ae/psycheros-windows-shell-fix) | Superseded by the manager-native 0.3.0-rc.1 plugin; the host issue is tracked as [Psycheros #40](https://github.com/PsycherosAI/Psycheros/issues/40). |
| Loom Gemini Parser Mod | [0.1.1](https://github.com/lyrishark/community-addons/releases/tag/psycheros-loom-gemini-parser-mod-v0.1.1) | [0.2.0 snapshot](https://github.com/lyrishark/community-addons/tree/b9094ae/psycheros-loom-gemini-parser-mod) | Superseded by the current 0.3.0-rc.1 source bridge. |
...
lists only current or staged artifacts.
