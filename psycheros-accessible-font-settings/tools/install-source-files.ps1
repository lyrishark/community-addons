...
if ($InstalledVersion -ne $RequiredVersion) {
  throw "This add-on requires Psycheros $RequiredVersion; found $InstalledVersion. No files were changed."
}

$Timestamp = Get-Date -Format "yyyyMMdd-HHmmss"
$BackupRoot = Join-Path $PsycherosDir "_accessible_font_settings_backup_$Timestamp"
...
Write-Host ""
Write-Host "Accessible font settings installed for Psycheros $RequiredVersion."
