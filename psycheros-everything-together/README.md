...
- Multiple images, documents, and audio files in ordinary chat and Yin Yang
  typed voice, including drag-and-drop, paste, document extraction, and chat
  history rendering.
...
or Screen Presence bridges over this suite because their guarded source files
overlap. Typography, voice resizing, and Windows shell selection remain manager
plugins. The unrelated provider-error overlay also remains excluded.
...
multi-file message, a configured expression sprite, screen presence in
