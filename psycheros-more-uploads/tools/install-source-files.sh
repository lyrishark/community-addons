...
backup_root="$root_full/packages/psycheros/_more_uploads_backup_$timestamp"
mkdir -p "$backup_root"
...
printf '3. In voice chat, switch to Yin Yang mode and attach a file before sending typed text.\n'
