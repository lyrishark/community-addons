...
$AddonName = "Voice Text Resize"
$AddonId = "psycheros-voice-text-resize"
$AddonVersion = "0.1.0"
$SupersededAddonIds = @()
...
$BackupRoot = Join-Path $PsycherosPackageDir "_voice_text_resize_backup_$Timestamp"
...
Write-Host "2. Open a voice call and switch to Yin Yang mode."
Write-Host "3. Type long text to confirm auto-grow, then drag a resize handle to confirm manual sizing."
Write-Host ""
Write-Host "Double-click a resize handle to return the typed voice input to adaptive sizing."
