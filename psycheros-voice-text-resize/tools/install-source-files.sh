...
addon_name="Voice Text Resize"
addon_id="psycheros-voice-text-resize"
addon_version="0.2.0"
...
backup_root="$psycheros_pkg_dir/_voice_text_resize_backup_$timestamp"
mkdir -p "$backup_root"
...
printf '2. Open a voice call and switch to Yin Yang mode.\n'
printf '3. Type long text to confirm auto-grow, then drag a resize handle to confirm manual sizing.\n\n'
printf 'Double-click a resize handle to return the typed voice input to adaptive sizing.\n'
