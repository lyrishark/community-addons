...
The plugin exports a tool named shell. Psycheros merges plugin tools after stock
tools, so this implementation replaces the stock registration without patching
the host.
